...
bedfile=$2 #/home/shush/profile/basenji/data/w32_l1024/sample_files/basset_sample_beds_top25.txt
output_dir=$3 #/home/shush/profile/tfprofile/datasets/top25
# mkdir -p $output_dir
...
bin/basenji_data.py $genome \
                    ...
                    -l $input_size -o $output_dir -t .1 -v .1 \
                    -w $pool_window --local -d $d
# #
scp merged_avoid_regions.bed "$output_dir/"
